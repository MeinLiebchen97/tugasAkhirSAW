      ...
      <table class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $data1->name }}</td>
              <td class="text-center">{{ number_format($data1->c1, 2, '.', '') }}</td>
              <td class="text-center">{{ number_format($data1->c2, 2, '.', '') }}</td>
              <td class="text-center">{{ number_format($data1->c3, 2, '.', '') }}</td>
              <td class="text-center">{{ number_format($data1->c4, 2, '.', '') }}</td>
              <td class="text-center">{{ number_format($data1->c5, 2, '.', '') }}</td>
            </tr>    
            @endforeach
          </tbody>
        </table>
    <small class="d-block text-end mt-3">
      <a class="btn btn-sm btn-bd-light mb-3 mb-md-0 rounded-2" href="/weight">
        Add Weight
      </a>
    </small>
  </div>
